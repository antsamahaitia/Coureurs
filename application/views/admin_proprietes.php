    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- View: rent_property.php -->
<div class="container-fluid">
    <h1>Gestion des propriétés</h1>

    <form action="<?php echo base_url('admin/ajouter_propriete'); ?>" method="post">
        <label for="reference">Référence:</label>
        <input type="text" id="reference" name="reference" required>

        <label for="idTypeBien">Type de bien:</label>
        <select id="idTypeBien" name="idTypeBien" required>
            <?php foreach ($types_biens as $type): ?>
                <option value="<?php echo $type['idTypeBien']; ?>"><?php echo $type['nom']; ?></option>
            <?php endforeach; ?>
        </select>
        ...
        <label for="loyerparmois">Loyer par mois:</label>
        <input type="number" id="loyerparmois" name="loyerparmois" step="0.01" required>
        ...
        <select id="idProprietaire" name="idProprietaire" required>
            <?php foreach ($proprietaires as $proprietaire): ?>
                <option value="<?php echo $proprietaire['id']; ?>"><?php echo $proprietaire['username']; ?></option>
            <?php endforeach; ?>
        </select>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($proprietes as $propriete): ?>
                <tr>
                    <td><?php echo $propriete['reference']; ?></td>
                    <td><?php echo $propriete['nom']; ?></td>
                    <td><?php echo $propriete['region']; ?></td>
                    <td><?php echo $propriete['loyerparmois']; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
