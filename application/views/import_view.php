    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Section -->
                <h1 class="mt-5">Import CSV Files</h1>
        
        <!-- Form for importing types of biens -->
        <form action="<?php echo site_url('Import/import_typebiens'); ?>" method="post" enctype="multipart/form-data" class="mt-4">
            <div class="form-group">
                <label for="typebiensFile">Import Types of Biens</label>
                <input type="file" name="csv_file" id="typebiensFile" class="form-control-file">
            </div>
            <button type="submit" class="btn btn-primary">Import Types of Biens</button>
        </form>

        <!-- Form for importing biens -->
        <form action="<?php echo site_url('Import/import_biens'); ?>" method="post" enctype="multipart/form-data" class="mt-4">
            <div class="form-group">
                <label for="biensFile">Import Biens</label>
                <input type="file" name="csv_file" id="biensFile" class="form-control-file">
            </div>
            <button type="submit" class="btn btn-primary">Import Biens</button>
        </form>

        <!-- Form for importing locations -->
        <form action="<?php echo site_url('Import/import_locations'); ?>" method="post" enctype="multipart/form-data" class="mt-4">
            <div class="form-group">
                <label for="locationsFile">Import Locations</label>
                <input type="file" name="csv_file" id="locationsFile" class="form-control-file">
            </div>
